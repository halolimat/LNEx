...
def initialize(bb, augmentType, cache, dataset_name, capital_word_shape=False,isInit=False):
    ...
    while geo_info is None:
        try:
            ...
            geo_locations, geo_info, extended_words3 =  osm_gazetteer.build_bb_gazetteer(bb, augmentType, dataset_name)
...
def is_cached(dataset):
    return osm_gazetteer.is_cached(dataset)
